            ...
            <div class="card sm:my-12  w-full shadow-none">
              <div class="card-body !p-10">
                <div class="text-center mb-8">
                  <a href="#"><img src="<?= base_url('assets_admin/images/logo-dark.svg') ?>" alt="img" class="mx-auto auth-logo"/></a>
                </div>
                ...
                <div class="flex justify-between items-end flex-wrap mt-4">
                  ...
                  <a href="register-v1.php" class="text-primary-500">Create Account</a>
                </div>
              </div>
            </div>
          </div>
