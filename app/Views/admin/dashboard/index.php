        ...
        <div class="dropdown-body header-notification-scroll relative py-4 px-5"
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="<?= base_url('assets_admin/images/user/avatar-1.jpg') ?>" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="<?= base_url('assets_admin/images/user/avatar-2.jpg') ?>" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="<?= base_url('assets_admin/images/user/avatar-3.jpg') ?>" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="<?= base_url('assets_admin/images/user/avatar-4.jpg') ?>" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="<?= base_url('assets_admin/images/user/avatar-5.jpg') ?>" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
      ...
      <div class="dropdown-menu dropdown-user-profile dropdown-menu-end pc-h-dropdown p-2 overflow-hidden">
        <div class="dropdown-header flex items-center justify-between py-4 px-5 bg-primary-500">
          <div class="flex mb-1 items-center">
            <div class="shrink-0">
              <img src="<?= base_url('assets_admin/images/user/avatar-2.jpg') ?>" alt="user-image" class="w-10 rounded-full" />
            </div>
            <div class="grow ms-3">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="<?= base_url('assets_admin/images/user/avatar-1.jpg') ?>" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="<?= base_url('assets_admin/images/user/avatar-2.jpg') ?>" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="<?= base_url('assets_admin/images/user/avatar-3.jpg') ?>" alt="activity-user" />
                        </td>
                        <td>
    ...
    <footer class="pc-footer">
      <div class="footer-wrapper container-fluid mx-10">
        <div class="grid grid-cols-12 gap-1.5">
          <div class="col-span-12 sm:col-span-6 my-1" style="display: flex; min-width: 800px; max-width: 800px; grid-gap: 8px;">
                    <p class="m-0">
                    © 2025 Supercar, Inc. Tous droits réservés. 
                  </p>
            <div class="separateur">&#8226;</div>
                <a href="https://codedthemes.com/" class="text-theme-bodycolor dark:text-themedark-bodycolor hover:text-primary-500 dark:hover:text-primary-500" target="_blank">Plan du site</a>
                <div class="separateur">&#8226;</div>
                <a href="https://codedthemes.com/" class="text-theme-bodycolor dark:text-themedark-bodycolor hover:text-primary-500 dark:hover:text-primary-500" target="_blank">Documentation du site</a>
                <div class="separateur">&#8226;</div>
                <a href="https://codedthemes.com/" class="text-theme-bodycolor dark:text-themedark-bodycolor hover:text-primary-500 dark:hover:text-primary-500" target="_blank">Info sur l'entreprise</a>
          </div>
