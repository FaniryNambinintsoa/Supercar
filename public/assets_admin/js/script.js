...
function setLayout() {
  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      script.src = '../assets_admin_admin/js/layout-horizontal.js'; // Load script for horizontal layout
      document.body.appendChild(script);
    } else if (layout === 'color-header') {
      // Change logo color for color-header layout
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../assets/images/logo_supercar.png');
      }
    } else if (layout === 'compact') {
      script.src = '../assets_admin_admin/js/layout-compact.js'; // Load script for compact layout
      document.body.appendChild(script);
    } else if (layout === 'tab') {
      script.src = '../assets_admin_admin/js/layout-tab.js'; // Load script for tab layout
      document.body.appendChild(script);
    }
  }
...
document.querySelectorAll('.auth-main.v2 .img-brand').forEach((img) => {
  img.setAttribute('src', '../assets_admin_admin/images/logo-white.svg');
});
